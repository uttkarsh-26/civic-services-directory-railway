...
if ($config === NULL) {
  fwrite(STDERR, "[civic-services-directory] No database configuration found. Set DATABASE_URL or PGHOST/PGPORT/PGUSER/PGPASSWORD/PGDATABASE.\n");
  exit(1);
}
if (!extension_loaded('pdo_pgsql')) {
  fwrite(STDERR, "[civic-services-directory] The pdo_pgsql PHP extension is missing.\n");
  exit(1);
}
...
try {
  ...
  fwrite(STDERR, "[civic-services-directory] database not ready (connection failed).\n");
  exit(1);
}
