...
try {
  if (drupal_railway_is_installed($pdo)) {
    echo "[civic-services-directory] Drupal is already installed; nothing to do.\n";
    exit(0);
  }
  ...
  $site_name = (is_string($site_name) && $site_name !== '') ? $site_name : 'Civic Services Directory';
  ...
  echo "[civic-services-directory] Installing Drupal (profile: $profile, site: $site_name)...\n";
  ...
  echo "[civic-services-directory] Drupal installed successfully.\n";
  exit(0);
}
finally {
