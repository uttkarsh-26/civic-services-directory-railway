...
| `preflight.sh` | Secret-safe container preflight (installed at `/opt/civic-services-directory/preflight.sh`) |
...
| `DRUPAL_SITE_NAME` | no | `Civic Services Directory` | Site name. |
