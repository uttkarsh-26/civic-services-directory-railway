...
Ready-to-paste configuration for publishing **civic-services-directory** as a Railway
...
| `DRUPAL_SITE_NAME` | `Civic Services Directory` | Optional |
...
- [ ] `docker compose exec web /opt/civic-services-directory/preflight.sh` → RESULT=PASS
