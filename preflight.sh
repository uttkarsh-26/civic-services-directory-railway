#!/usr/bin/env bash
#
# civic-services-directory deployment preflight.
#
...
#
# Installed in the image at /opt/civic-services-directory/preflight.sh. Run it inside
# the container (docker compose exec web /opt/civic-services-directory/preflight.sh).
